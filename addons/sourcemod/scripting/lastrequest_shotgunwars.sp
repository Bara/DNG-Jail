...
public OnPluginStart()
{
	...
	CreateConVar("sm_shotgunwars_version", SGW_VERSION, "LastReqest: Shotgunwars", FCVAR_NONE|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY|FCVAR_DONTRECORD);
