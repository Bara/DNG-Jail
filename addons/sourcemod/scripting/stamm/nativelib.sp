...
nativelib_Start()
{
	...
	CreateNative("STAMM_CheckSpecialVIP", nativelib_CheckSpecialVIP);
...
// Check by 3rd party plugin for special vip
public nativelib_CheckSpecialVIP(Handle:plugin, numParams)
{
	new client = GetNativeCell(1);
