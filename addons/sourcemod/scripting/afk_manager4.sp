...
void RegisterCvars() // Cvar Registrations
{
	...
	hCvarMinPlayersKick = CreateConVar("sm_afk_kick_min_players", "4", "Minimum number of connected clients required for AFK kick to be enabled. [DEFAULT: 6]");
	hCvarAdminsImmune = CreateConVar("sm_afk_admins_immune", "2", "Should admins be immune to the AFK Manager? [0 = DISABLED, 1 = COMPLETE IMMUNITY, 2 = KICK IMMUNITY, 3 = MOVE IMMUNITY]");
	hCvarAdminsFlag = CreateConVar("sm_afk_admins_flag", "z", "Admin Flag for immunity? Leave Blank for any flag.");
	...
	hCvarTimeToKick = CreateConVar("sm_afk_kick_time", "240.0", "Time in seconds (total) client must be AFK before being kicked. [0 = DISABLED, DEFAULT: 120.0 seconds]");
