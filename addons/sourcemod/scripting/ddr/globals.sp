#define SPEC_FIRSTPERSON 4
#define SPEC_3RDPERSON   5
...
// Platform origins
float g_fTeleGameCT[3];
float g_fTeleGameT[3];
...
// Where is player
bool g_bZone1[MAXPLAYERS + 1];
bool g_bZone2[MAXPLAYERS + 1];
bool g_bZone3[MAXPLAYERS + 1];
